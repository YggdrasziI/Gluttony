...
public class GluttonyPotato9 extends ItemFood implements IHasModel
{

    public GluttonyPotato9(String name, int amount, float saturation, boolean isWolfFood)
    {
    ...
    {
        tooltip.add("387,420,489 Potatoes");
