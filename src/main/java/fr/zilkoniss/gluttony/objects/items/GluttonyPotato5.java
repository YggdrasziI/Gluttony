...
public class GluttonyPotato5 extends ItemFood implements IHasModel
{

    public GluttonyPotato5(String name, int amount, float saturation, boolean isWolfFood)
    {
