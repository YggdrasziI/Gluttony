...
public class GluttonyPotato7 extends ItemFood implements IHasModel
{

    public GluttonyPotato7(String name, int amount, float saturation, boolean isWolfFood)
    {
    ...
    {
        tooltip.add("4,782,969 Potatoes");
