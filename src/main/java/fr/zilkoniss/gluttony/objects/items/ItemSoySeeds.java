...
public class ItemSoySeeds extends Item implements IHasModel, IPlantable
{
    public ItemSoySeeds(String name) 
    {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            worldIn.setBlockState(pos.up(), BlocksMod.SOY_PLANT.getDefaultState());
            stack.shrink(1);
    ...
    {
        return BlocksMod.SOY_PLANT.getDefaultState();
    }
}
