...
public class GluttonyPotato6 extends ItemFood implements IHasModel
{

    public GluttonyPotato6(String name, int amount, float saturation, boolean isWolfFood)
    {
