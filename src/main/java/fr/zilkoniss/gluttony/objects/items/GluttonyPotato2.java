...
public class GluttonyPotato2 extends ItemFood implements IHasModel
{

    public GluttonyPotato2(String name, int amount, float saturation, boolean isWolfFood)
    {
