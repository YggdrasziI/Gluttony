...
public class ItemNatureSeeds extends Item implements IHasModel, IPlantable
{
    public ItemNatureSeeds(String name) 
    {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            worldIn.setBlockState(pos.up(), BlocksMod.NATURE_PLANT.getDefaultState());
            stack.shrink(1);
