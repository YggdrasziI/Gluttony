...
public class ItemRiceSeeds extends Item implements IHasModel, IPlantable
{
    public ItemRiceSeeds(String name) 
    {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            worldIn.setBlockState(pos.up(), BlocksMod.RICE_PLANT.getDefaultState());
            stack.shrink(1);
    ...
    {
        return BlocksMod.RICE_PLANT.getDefaultState();
    }
}
