...
public class GluttonyPotato8 extends ItemFood implements IHasModel
{

    public GluttonyPotato8(String name, int amount, float saturation, boolean isWolfFood)
    {
    ...
    {
        tooltip.add("43,046,721 Potatoes");
