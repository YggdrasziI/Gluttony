...
public class GluttonyPotato1 extends ItemFood implements IHasModel
{

    public GluttonyPotato1(String name, int amount, float saturation, boolean isWolfFood)
    {
