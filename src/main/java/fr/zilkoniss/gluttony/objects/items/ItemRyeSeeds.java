...
public class ItemRyeSeeds extends Item implements IHasModel, IPlantable
{
    public ItemRyeSeeds(String name) 
    {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            worldIn.setBlockState(pos.up(), BlocksMod.RYE_PLANT.getDefaultState());
            stack.shrink(1);
    ...
    {
        return BlocksMod.RYE_PLANT.getDefaultState();
    }
}