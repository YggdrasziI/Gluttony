...
public class GluttonyPotato4 extends ItemFood implements IHasModel
{

    public GluttonyPotato4(String name, int amount, float saturation, boolean isWolfFood)
    {
